...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  req.body.imageCover = `tour-${req.params._id}-${Date.now()}-cover.jpeg`
  ...
  await Promise.all(req.file.images.map(async (file, i) => {
